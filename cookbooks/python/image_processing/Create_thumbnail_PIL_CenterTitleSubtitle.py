...
# Load the font
font_path = r"C:/Windows/Fonts/tahomabd.ttf"  # Replace with the path to your font file
font_size = title_font_size  # Replace with your desired font size
...
stroke_width = 4  # Adjust the width of the stroke as needed
stroke_color = "red"
...
start_y = ((image_size[1] - total_text_height) // 2)-140
...
for i, line in enumerate(title.split("\n")):
    ...
    # Draw the text in the center fill="black"
    draw.text((text_position_x, text_position_y), line, font=font, fill="#808080")
# Save the image
...
font_size = subtitle_font_size  # Replace with your desired font size
font = ImageFont.truetype(font_path, font_size)
# Create a draw object
draw = ImageDraw.Draw(image)
# Calculate the width and height of the text
text_width, text_height = draw.textbbox((0, 0), subtitle, font=font)[2:4]
# Calculate the position of the text to center it in the image
text_position = ((image_size[0] - text_width) // 2, (image_size[1] - text_height) // 2)
# Draw the text onto the image
...
# Calculate the width and height of a single line of text
single_line_height = draw.textbbox((0, 0), "Sample subtitle", font=font)[3]

# Calculate the total height of the text
line_height = single_line_height * 0.8  # Adjust the line height as needed
total_text_height = len(subtitle.split("\n")) * line_height

# Calculate the starting y position
start_y = ((image_size[1] - total_text_height))-60 
...
# Subtitle
subtitle = Image.open('subtitle.png').convert('RGBA')

# Define the position where the title image will be pasted onto the background image
title_position = (100, 0)  # Replace with your desired position

# Paste the title onto the background
background.paste(subtitle, title_position, subtitle)


# Save the result
background.save('YT_thumbnail.png')

# Convert to JPG
background.convert('RGB').save('YT_thumbnail.jpg')

# Optionally, display the result
#background.show()

# Display the result with a specific program
subprocess.run(['C:\\Program Files\\IrfanView\\i_view64.exe', 'YT_thumbnail.jpg'])
