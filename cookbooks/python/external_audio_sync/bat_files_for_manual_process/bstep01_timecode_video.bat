...
ffmpeg -i extaudio.%aFileType% -ss 00:00:00 -to 00:00:59 -filter_complex "[0:a]showwaves=s=1920x1080:mode=line:rate=30,format=yuv420p[v]" -map "[v]" -map 0:a -r 30 -y "extaudio_waveform.mp4"
